...
def run_pipeline():
    try:
        ...
        # Step 2: Validate the data using the artifact from Churn_Pred.components.ingestion
        ...
        # Step 3: Transform the data using the artifact from Churn_Pred.components.Data VALIDATION
        ...
        # Step 4: Training model data using the artifact from Churn_Pred.components.Data TRANSFORMATION
